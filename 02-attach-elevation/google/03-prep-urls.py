...
# input data
nodes_folder = config['elevation_google_nodeclusters_path'] #clustered nodes with xy data
elevations_path = config['elevation_google_elevations_path'] #any preexisting elevations data from previous runs

# output data
urls_path = config['elevation_google_urls_path'] #urls we create
nodestoget_path = config['elevation_google_nodestoget_path'] #node osmids in same order as their coords appear in batched lists of urls
